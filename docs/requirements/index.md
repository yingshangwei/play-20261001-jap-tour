...
需求文档只描述要解决的问题、范围、约束和验收标准，不承载实现进度。

| 模块 | 文档 | 状态 |
| --- | --- | --- |
| 多攻略配置平台 | [guide-platform/requirements.md](guide-platform/requirements.md) | Active |
| 关西旅行约束 | [kansai-2026/constraints.md](kansai-2026/constraints.md) | Active |
| Day 2–9 每日手账 | [day-journals/requirements.md](day-journals/requirements.md) | Active |
| └─ 手账天气子模块 | [day-journals/weather-module.md](day-journals/weather-module.md) | Active |
