...
export default function TripMap() {
  ...
  return (
    <div className="real-map-panel">
      ...
      <div className="restaurant-map-heading"><div><p className="eyebrow dark">DINING PINS</p><h3>餐厅候选与顺路备选</h3></div><p>正式餐候选按行程适配日期显示，资料核对于 2026 年 9 月 3 日；评分、价格和席位会变化。“3 人可”只代表规则与桌席支持 3 人，并不代表目标日期仍有 3 个余位。</p></div>
